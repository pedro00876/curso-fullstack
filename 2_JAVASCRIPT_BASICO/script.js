...
/*
- Parâmetros: é a variável (escopo da fuunção) que irá receber um valor em u ma função.
- Argumentos: é o valor que é pensado para a função.
*/
...
const reqMessage = (username, email) => {
  console.log(`Olá, ${username}. o Seu email é ${email}.`)
}

reqMessage('Pedro Elias', 'pedroelias@gmail.com')

// CALLBACKFUNCTION: é uma função passada para outra função como um argumento.
